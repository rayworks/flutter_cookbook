...
abstract class WebViewPlatformCallbacksHandler {
  ...
  /// Invoked by [WebViewPlatformController] when a page has failed loading.
  void onPageFailed(String url, dynamic error);

  /// Invoked by [WebViewPlatformController] when video layout changed via interaction.
...
abstract class WebViewPlatformController {
  ...
  Future<void> restoreOriginalVideo() {
    throw UnimplementedError(
        "WebView getTitle is not implemented on the current platform");
  }
}
